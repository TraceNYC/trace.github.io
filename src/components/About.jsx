    ...
    <Box
      ...
      <Flex
        ...
        >
          <Heading
            as='h1'
            fontSize={['4.5rem','5.5rem','6.5rem','7.5rem','8.5rem']}
          ...
          <Text w={['90%','90%','60%','50%','50%']} color='#fff' pr='4rem' pl='4rem' fontSize={['.9rem','1.2rem','1.4rem','1.4rem','1.4rem']} lineHeight='1.7' textAlign='justify'>
