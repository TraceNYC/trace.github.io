  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text w={['90%', '90%', '60%', '50%', '50%']} color='#fff' pr='4rem' pl='4rem' fontSize={['.85rem', '0.85', '0.85rem', '1.2rem', '1.4rem']} lineHeight='1.7' textAlign='justify'>
      ...
      <DownButton navId='#Features' bottom='4vh' />
    </Flex>
  )
}
